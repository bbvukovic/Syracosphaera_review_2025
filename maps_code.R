...
dukic2025 <- read_excel("Dukic2025.xlsx", sheet="Sheet2") #data from the 2018 COCCOMIX dataset (https://www.science.org/doi/10.1126/sciadv.adf6973)
...
data_new <-rbind(data_new, dukic2025)   #combining data from CASCADE and COCCOMIX
